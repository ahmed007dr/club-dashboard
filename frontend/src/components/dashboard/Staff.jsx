        ...
        >
          <div className="modal bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <ul className="text-sm space-y-2">
              <li>
                <strong>Shift ID:</strong> {selectedShift.id}
              </li>
              <li>
                <strong>Date:</strong> {selectedShift.date}
              </li>
              <li>
                <strong>Shift Start:</strong> {selectedShift.shift_start}
              </li>
              <li>
                <strong>Shift End:</strong> {selectedShift.shift_end}
              </li>
              <li>
                <strong>Club:</strong> {selectedShift.club_details?.name}
              </li>
              <li>
                <strong>Staff:</strong>{" "}
