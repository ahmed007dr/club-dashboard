  ...
  return (
    ...
    <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-1.26 1.26a1 1 0 00-.707.293l-3.147 3.147a1 1 0 01-1.414-1.414l1.498-1.498a1 1 0 00.707-.293l1.26-1.26a1 1 0 011.21-.502z" />
          </svg>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-gray-700">تمت الإحالة من:</span>
