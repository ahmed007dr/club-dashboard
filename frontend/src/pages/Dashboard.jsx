...
import { FaMoneyCheckAlt, FaCalendarAlt, FaFileAlt } from 'react-icons/fa'; // Payroll icons
...
const Dashboard = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      children: [
        { path: 'payroll-periods', name: 'فترات الرواتب', icon: <FaCalendarAlt /> },
        { path: 'payroll-report', name: 'تقرير الرواتب', icon: <FaFileAlt /> },
        { path: 'create-payroll-period', name: 'إنشاء فترة رواتب', icon: <FaCalendarAlt /> },
      ],
    },
  ];
